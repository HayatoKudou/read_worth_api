...
(
    ...
    `name`                    varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
    `enable_purchase_limit`   tinyint(1)                              NOT NULL,
    `purchase_limit`          int                                     NOT NULL,
    `purchase_limit_unit`     varchar(20) COLLATE utf8mb4_unicode_ci  NOT NULL DEFAULT 'monthly',
    `private_ownership_allow` tinyint(1)                              NOT NULL DEFAULT '0',
    `created_at`              timestamp                               NULL     DEFAULT NULL,
    `updated_at`              timestamp                               NULL     DEFAULT NULL,
    PRIMARY KEY (`id`),
